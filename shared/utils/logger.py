...
class ByteCNetworkAgentLogger:
    """ByteC-Network-Agent 日志记录器"""
    
    def __init__(self, name="ByteC-Network-Agent"):
...
# 创建全局日志实例
logger = ByteCNetworkAgentLogger()
